...
<head>
    <meta charset="utf-8">
    <title>controllers/attachment.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">controllers/attachment.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>var botconfig	= require('../config/botconfig');
