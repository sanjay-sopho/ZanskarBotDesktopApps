...
<head>
    <meta charset="utf-8">
    <title>NGINB - Documentation</title>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">NGINB - A Rivescript-Node engine to make bots interaction with Facebook Messenger and Databases easier</div>
...
<dl class="details">
    ...
    <dd class="tag-version"><ul class="dummy"><li>0.1.5</li></ul></dd>
    ...
    <dd class="tag-author">
        <ul>
            <li><a href="mailto:tostegroo@gmail.com">Fabio Toste</a></li>
        </ul>
    </dd>
    ...
    <h4 class="name" id="addEventListener"><span class="type-signature"></span>addEventListener<span class="signature">(listener, callback)</span><span class="type-signature"></span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last">A string with one of the listeners:<br>
                              ...
                              <b>HandleCustomMessageReplyItems</b></td>
        </tr>
...
<span class="param-type">function</span>
            ...
            <td class="description last">The function to be called on event</td>
        </tr>
...
<dl class="details">
    ...
    <h4 class="name" id="configure"><span class="type-signature"></span>configure<span class="signature">(options)</span><span class="type-signature"></span></h4>
...
<span class="param-type"><a href="global.html#BotOptions">BotOptions</a></span>
            ...
            <td class="description last">Bot options object</td>
        </tr>
...
<dl class="details">
    ...
    <h4 class="name" id="dispatchDirectMessage"><span class="type-signature"></span>dispatchDirectMessage<span class="signature">(message, event)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">An object (The "text" key is required)</td>
        </tr>
...
<span class="param-type"><a href="global.html#Event">Event</a></span>
            ...
            <td class="description last">An event object</td>
        </tr>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="dispatchEvent"><span class="type-signature"></span>dispatchEvent<span class="signature">(event)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="getBotController"><span class="type-signature"></span>getBotController<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Bot_Controller.html">Bot_Controller</a>}</span></h4>
...
<span class="param-type"><a href="Bot_Controller.html">Bot_Controller</a></span>
    ...
    <h4 class="name" id="getBotResponse"><span class="type-signature"></span>getBotResponse<span class="signature">(event)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type"><a href="global.html#Event">Event</a></span>
            ...
            <td class="description last">An Event object sent by facebook controller</td>
        </tr>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="getFacebookController"><span class="type-signature"></span>getFacebookController<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Facebook_Controller.html">Facebook_Controller</a>}</span></h4>
...
<span class="param-type"><a href="Facebook_Controller.html">Facebook_Controller</a></span>
    ...
    <h4 class="name" id="getMenuController"><span class="type-signature"></span>getMenuController<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Menu_Controller.html">Menu_Controller</a>}</span></h4>
...
<span class="param-type"><a href="Menu_Controller.html">Menu_Controller</a></span>
    ...
    <h4 class="name" id="getPageController"><span class="type-signature"></span>getPageController<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="Page_Controller.html">Page_Controller</a>}</span></h4>
...
<span class="param-type"><a href="Page_Controller.html">Page_Controller</a></span>
    ...
    <h4 class="name" id="getUserController"><span class="type-signature"></span>getUserController<span class="signature">()</span><span class="type-signature"> &rarr; {<a href="User_Controller.html">User_Controller</a>}</span></h4>
...
<span class="param-type"><a href="User_Controller.html">User_Controller</a></span>
    ...
    <h4 class="name" id="sendMessageEvent"><span class="type-signature"></span>sendMessageEvent<span class="signature">(event, user_data)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type"><a href="global.html#Event">Event</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>user_data</code></td>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">If you have a previous loaded userdata, you can send it here</td>
        </tr>
...
<span class="param-type">Object</span>
    ...
    <h4 class="name" id="setEntities"><span class="type-signature"></span>setEntities<span class="signature">(entities, lang)</span><span class="type-signature"> &rarr; {Object}</span></h4>
...
<span class="param-type">Array.&lt;<a href="global.html#EntityConfig">EntityConfig</a>></span>
            ...
            <td class="description last">An object to be transformed to subs in rivescript - see: https://github.com/tostegroo/rivescript-nginb-js/blob/master/template-files/entities.js</td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last">The brain language to be used to fill the subs</td>
        </tr>
...
<footer>
    Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.3</a> on Mon May 15 2017 12:10:24 GMT-0300 (E. South America Standard Time) using the Toast theme.
</footer>
