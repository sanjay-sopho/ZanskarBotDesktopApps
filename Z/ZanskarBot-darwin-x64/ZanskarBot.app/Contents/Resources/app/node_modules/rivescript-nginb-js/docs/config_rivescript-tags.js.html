...
<head>
    <meta charset="utf-8">
    <title>config/rivescript-tags.js - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">config/rivescript-tags.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>/** @mixin Rivescript_Tags
